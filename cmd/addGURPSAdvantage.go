...
// addGURPSAdvantageCmd represents the addGURPSAdvantage command
var addGURPSAdvantageCmd = &cobra.Command{
	Use:   "addGURPSAdvantage",
	Short: "Sets up an Add Card dialog to add a GURPS Advantage",
		...
		_, err := ac.GuiAddCards(ac.GuiAddCardsParams{
			Note: ac.GuiAddCardsNote{
				...
				Fields: map[string]string{
					"Context":     `<img src="gurps-basic-set-cover-image.png"><br><div class="context-alt-text">GURPS</div><div>Advantages</div>`,
...
func init() {
	rootCmd.AddCommand(addGURPSAdvantageCmd)

	// Here you will define your flags and configuration settings.

	// Cobra supports Persistent Flags which will work for this command
	// and all subcommands, e.g.:
	// addGURPSAdvantageCmd.PersistentFlags().String("foo", "", "A help for foo")

	// Cobra supports local flags which will only run when this command
	// is called directly, e.g.:
	// addGURPSAdvantageCmd.Flags().BoolP("toggle", "t", false, "Help message for toggle")
}
